...
<body>
    ...
    <div class="container-sm" style="padding-top: 30px">
        <h4>Add Tags on posts</h4>
        @foreach ($posts as $post)
            <p>Tags: {{ str_replace(['[', ']', '"'], '', $post->tags->pluck('name')) }} </p>
            <div style="padding: 15px; border: 2px solid #ff0000; border-radius: 10px;">
                ...
                <button type="button" data-id="{{ $post->id }}" class="btn btn-warning" data-bs-toggle="modal"
                    data-bs-target="#exampleModal{{ $post->id }}">Add Tag</button>
                <br>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('storetag', $post->id) }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="message-text" class="col-form-label">Create your
                                            Tags:</label>
