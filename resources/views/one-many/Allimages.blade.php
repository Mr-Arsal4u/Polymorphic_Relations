                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <button type="button" data-id="{{ $image->id }}" class="btn btn-warning"
                                ...
                                data-bs-target="#exampleModal{{ $image->id }}">Comment</button>
                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Comment on Image</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="{{ route('Imgcomment', $image->id) }}" method="POST">
                                            @csrf
                                            <div class="mb-3">
